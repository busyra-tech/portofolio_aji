...
const ProjectModal: FunctionComponent<ProjectModalProps> = ({
	project,
	onClose,
}) => {
	...
	return (
		<div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 animate-fadeIn">
			...
			{/* Modal Dialog */}
			<div className="relative w-full max-w-4xl max-h-[90vh] flex flex-col md:flex-row bg-white dark:bg-dark-800 rounded-2xl shadow-2xl overflow-hidden z-10">
				{/* Image Section */}
